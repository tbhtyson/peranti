...
/*
    ...
    Cmdline:
        sokol-shdc -i shaders/triangle.glsl -o generated/triangle.glsl.h -l spirv_vk:glsl410:metal_macos:hlsl5
...
*/
static const uint8_t vs_source_hlsl5[762] = {
    ...
    0x6d,0x76,0x70,0x29,0x3b,0x0a,0x20,0x20,0x20,0x20,0x63,0x6f,0x6c,0x6f,0x72,0x20,
...
/*
    ...
    void main()
    {
        gl_Position = _19.mvp * vec4(position, 1.0);
        color = color0;
    }

*/
static const uint8_t vs_bytecode_spirv_vk[1260] = {
    ...
    0x23,0x00,0x00,0x00,0x25,0x00,0x00,0x00,0x03,0x00,0x03,0x00,0x02,0x00,0x00,0x00,
    ...
    0x5f,0x31,0x39,0x00,0x05,0x00,0x05,0x00,0x19,0x00,0x00,0x00,0x70,0x6f,0x73,0x69,
    0x74,0x69,0x6f,0x6e,0x00,0x00,0x00,0x00,0x05,0x00,0x04,0x00,0x23,0x00,0x00,0x00,
    0x63,0x6f,0x6c,0x6f,0x72,0x00,0x00,0x00,0x05,0x00,0x04,0x00,0x25,0x00,0x00,0x00,
    ...
    0x22,0x00,0x00,0x00,0x20,0x00,0x00,0x00,0x3d,0x00,0x04,0x00,0x07,0x00,0x00,0x00,
...
static inline const sg_shader_desc* triangle_shader_desc(sg_backend backend) {
    ...
    if (backend == SG_BACKEND_VULKAN) {
        ...
        if (!valid) {
            ...
            desc.vertex_func.bytecode.size = 1260;
            desc.vertex_func.entry = "main";
