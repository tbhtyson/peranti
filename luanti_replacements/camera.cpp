...
void Camera::update(LocalPlayer* player, f32 frametime, f32 tool_reload_ratio)
{
	...
	peranti_camera_sync(
		...
		m_camera_direction.X, m_camera_direction.Y, m_camera_direction.Z,
		m_fov_x, m_fov_y,
		m_cameranode->getNearValue(), m_cameranode->getFarValue(),
		m_camera_offset.X, m_camera_offset.Y, m_camera_offset.Z
	);
